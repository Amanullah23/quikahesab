...
export default function CancelForm({ billId }: { billId: string }) {
  ...
  return (
    <button
      ...
      className="flex items-center gap-1.5 bg-badge-red-bg text-badge-red-text px-4 py-2 rounded-full text-sm font-medium hover:opacity-80 active:scale-95 transition duration-150"
    >
      <X size={14} />
      Cancel Bill
    </button>
